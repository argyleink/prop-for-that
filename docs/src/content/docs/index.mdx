...
## Tag it in HTML, react to it in CSS
...
One module import and a `data-props-for` attribute — that's it. Plugins like `pointer` load on demand. Prefer programmatic control and teardown? There's an [imperative API](/reference/api/) too.
